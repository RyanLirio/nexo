...
@Module({
  imports: [UsersModule, TeamsModule, ProjectsModule, CheckInsModule],
  controllers: [HealthController, KnowledgeController, HelpRequestsController],
  providers: [PrismaService, KnowledgeService, HelpRequestsService],
})
