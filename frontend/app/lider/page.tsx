    ...
    <main id="main-content" tabIndex={-1} className="content dashboard">
      ...
      <div className="leader-grid">
        <aside className="attention-panel card" aria-labelledby="attention-title">
          <span className="overline">Onde apoiar</span><h2 id="attention-title">Pontos de atenção</h2><p>Dificuldades informadas nos projetos acompanhados.</p>
      ...
      <section className="metrics" aria-label="Resumo da equipe">
        <div className="metric-card card"><span>Colaboradores</span><strong>01</strong><small>pessoa acompanhada</small></div>
        <div className="metric-card card"><span>Projetos acompanhados</span><strong>{projects.length.toString().padStart(2, '0')}</strong><small>em diferentes etapas</small></div>
        <div className="metric-card card metric-attention"><span>Dificuldades informadas</span><strong>{attentionProjects.length.toString().padStart(2, '0')}</strong><small>contextos para acompanhar</small></div>
      </section>
    </main>
  );
}
